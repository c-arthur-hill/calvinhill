...
class DownloadMedia implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $ext = pathinfo(parse_url($media->original_url, PHP_URL_PATH), PATHINFO_EXTENSION);
        if ($ext) {
            $ext = '.' . $ext;
        }
        ...
        // curl original url
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, $media->original_url);
        curl_setopt($ch, CURLOPT_SSL_VERIFYPEER,false);
        // return file instead of true/false
        ...
        $thumbnail = tmpfile();
        $thumbnailPath = stream_get_meta_data($thumbnail)['uri'];
