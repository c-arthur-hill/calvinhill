                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <form class="p-3 bg-light border h-100" method="POST" action="{{ route('contact.update') }}">
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-danger rounded-0">Get started</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="col-lg-10 offset-lg-1">
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-1">
                    ...
                    <p>I understand the requirements. I design the interface and create a step-by-step plan. I write the code. I deploy the servers. I fix what breaks.</p>
                    <p></p>
                    <div class="mt-5 mb-5">
